...
import xyz.jekyllex.terminal.TerminalColors;
import xyz.jekyllex.terminal.TerminalSession;
import xyz.jekyllex.terminal.TerminalSession.SessionChangedCallback;
import xyz.jekyllex.terminal.TextStyle;
import xyz.jekyllex.view.TerminalView;
...
public final class TermuxActivity extends Activity implements ServiceConnection {
    ...
    public static final String TERMUX_FAILSAFE_SESSION_ACTION = "xyz.jekyllex.app.failsafe_session";
    ...
    private static final String RELOAD_STYLE_ACTION = "xyz.jekyllex.app.reload_style";
    ...
    void checkForFontAndColors() {
        try {
            @SuppressLint("SdCardPath") File fontFile = new File("/data/data/xyz.jekyllex/files/home/.termux/font.ttf");
            @SuppressLint("SdCardPath") File colorsFile = new File("/data/data/xyz.jekyllex/files/home/.termux/colors.properties");
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case CONTEXTMENU_STYLING_ID: {
                ...
                stylingIntent.setClassName("xyz.jekyllex.styling", "xyz.jekyllex.styling.TermuxStyleActivity");
                try {
                    ...
                    new AlertDialog.Builder(this).setMessage(R.string.styling_not_installed)
                        .setPositiveButton(R.string.styling_install, (dialog, which) -> startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("http://play.google.com/store/apps/details?id=xyz.jekyllex.styling")))).setNegativeButton(android.R.string.cancel, null).show();
                }
                return true;
            }
