...
import xyz.jekyllex.app.packagemanager.PackageInstaller;
import xyz.jekyllex.app.packagemanager.PackageLister;
import xyz.jekyllex.app.packagemanager.PackageUninstaller;
import xyz.jekyllex.terminal.EmulatorDebug;
import xyz.jekyllex.terminal.TerminalSession;
import xyz.jekyllex.terminal.TerminalSession.SessionChangedCallback;
...
public final class TermuxService extends Service implements SessionChangedCallback {
    ...
    public static final String FILES_PATH = "/data/data/xyz.jekyllex/files";
    public static final String PREFIX_PATH = FILES_PATH + "/usr";
    public static final String HOME_PATH = FILES_PATH + "/home";

    private static final int NOTIFICATION_ID = 1337;

    private static final String ACTION_STOP_SERVICE = "xyz.jekyllex.service_stop";

    private static final String ACTION_LOCK_WAKE = "xyz.jekyllex.service_wake_lock";
    private static final String ACTION_UNLOCK_WAKE = "xyz.jekyllex.service_wake_unlock";
    /**
     * Intent action to launch a new terminal session. Executed from TermuxWidgetProvider.
     */
    public static final String ACTION_EXECUTE = "xyz.jekyllex.service_execute";

    public static final String EXTRA_ARGUMENTS = "xyz.jekyllex.execute.arguments";

    public static final String EXTRA_CURRENT_WORKING_DIRECTORY = "xyz.jekyllex.execute.cwd";
    public static final String EXTRA_EXECUTE_IN_BACKGROUND = "xyz.jekyllex.execute.background";

    /*
     * APK service intents
     * */

    private static final String ACTION_INSTALL_PACKAGES = "xyz.jekyllex.install_packages";
    private static final String ACTION_LIST_PACKAGES = "xyz.jekyllex.list_packages";
    private static final String ACTION_UNINSTALL_PACKAGES = "xyz.jekyllex.uninstall_packages";
    ...
    TerminalSession createTermSession(String executablePath, String[] arguments, String cwd, boolean failSafe) {
        ...
        Intent stylingIntent = new Intent("xyz.jekyllex.app.reload_style");
        stylingIntent.putExtra("xyz.jekyllex.app.reload_style", "styling");
