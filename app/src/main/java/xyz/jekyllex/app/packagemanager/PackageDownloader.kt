...
import xyz.jekyllex.app.packagemanager.Constants.Companion.APK_REPO_URL
import xyz.jekyllex.app.packagemanager.PackageInstaller.Companion.log
...
class PackageDownloader(val context: Context) {
    ...
    fun download(packageName: String) {
        ...
        builder = NotificationCompat.Builder(context, "termux_notification_channel").setChannelId(
